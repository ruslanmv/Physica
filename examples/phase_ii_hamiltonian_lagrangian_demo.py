...
def demo_hamiltonian_pendulum():
    ...
    ratio = energy_drift_rk45[-1] / energy_drift_symplectic[-1]
    print(f"\nSymplectic integrator preserves energy {ratio:.1f}× better!")
    print()
...
def demo_double_pendulum_chaos():
    ...
    print("Initial perturbation: 0.001 rad")
...
def demo_action_principle():
    ...
    comparison = "lower" if action_physical < action_perturbed else "higher"
    print(f"Physical trajectory has {comparison} action!")
    print(
