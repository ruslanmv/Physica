...
def demo_ideal_gas():
    ...
    print(f"Standard conditions (STP):")
    ...
    print(f"  (Theoretical: 22.4 L/mol)")
    print()
...
def demo_van_der_waals():
    ...
    print(f"Van der Waals equation for CO₂:")
...
def demo_carnot_cycle():
    ...
    print(f"operating between these temperatures (Second Law).")
    ...
    for i, (v, p, label) in enumerate(zip(volumes[:4], pressures[:4], labels)):
...
def demo_otto_cycle():
    ...
    print(f"Otto cycle (gasoline engine):")
...
def demo_entropy_second_law():
    ...
    print(f"Free expansion (irreversible):")
    ...
    print(f"Process is irreversible.")
    print()
